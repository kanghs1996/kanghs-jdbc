package com.kanghs.jdbc.template;
...
import com.kanghs.jdbc.raw.Article;
import com.kanghs.jdbc.raw.ArticleDao;
...
public class ArticleDaoImplUsingTemplate implements ArticleDao {
	...
	public ArticleDaoImplUsingTemplate() {
		dataSource = new MariaDbDataSource(
				"jdbc:mariadb://localhost:3306/kanghsdb?user=kanghs&password=kanghs");
